...
def build_dataset(feature_encoder, train_data=None, valid_data=None, test_data=None,
    ...
    if rebuild_dataset:
        ...
        if os.path.exists(feature_map_path):
            ...
            feature_encoder.fit(train_ddf, rebuild_dataset=True, **kwargs) # feature_map.json, feature_processor.pkl, feature_vocab.json form train data
            transform(feature_encoder, train_ddf, 'train', block_size=data_block_size) # train.parquet
            del train_ddf
            gc.collect()
            ...
            if valid_ddf is not None:
                ...
                transform(feature_encoder, valid_ddf, 'valid', block_size=data_block_size) # valid.parquet
                del valid_ddf
                gc.collect()
            ...
            if test_ddf is not None:
                ...
                transform(feature_encoder, test_ddf, 'test', block_size=data_block_size) # test.parquet
                del test_ddf
                gc.collect()
